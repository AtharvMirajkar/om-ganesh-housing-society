...
const newsItems = [
  {
    ...
    category: "Meeting",
    excerpt: "The Annual General Meeting for the year 2025-26 will be held on January 28th, 2026 at the Community Hall. All members are requested to attend.",
    important: true
  },
  {
    id: 2,
    ...
    excerpt: "Water tank cleaning will be conducted on the last Sunday of every month. Please store water accordingly.",
    important: false
  },
  {
    id: 3,
    ...
    date: "January 8, 2026",
    category: "Event",
    excerpt: "Join us for Republic Day celebrations on January 26th at 8:00 AM at the society garden. Flag hoisting followed by cultural programs.",
    important: true
  },
  {
    id: 4,
    ...
    category: "Notice",
    excerpt: "New parking allocation guidelines have been implemented. Please check the notice board for your assigned parking space.",
    important: false
  },
  {
    id: 5,
    ...
    category: "Event",
    excerpt: "Thank you to all residents who participated in making our Diwali celebration a grand success. View the photo gallery on the society app.",
    important: false
  }
];
          ...
          >
            <div className="h-full p-8 bg-gradient-to-br from-[#2d2a26] to-[#3d3833] rounded-3xl relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${getCategoryColor(newsItems[0].category)} mb-4 ml-2`}>
